...
export type Platform = 'amazon' | 'flipkart' | 'croma' | 'vijay_sales' | 'reliance_digital';
...
export const POINTS_VALUE: Record<string, number> = {
  ...
  axis_flipkart:     0.015,
  icici_amazon:      0.010,
  icici_emeralde:    0.020,
  sbi_cashback:      0.010,
  sbi_elite:         0.015,
  kotak_811:         0.010,
  idfc_wealth:       0.015,
  amex_plat_travel:  0.025,
  amex_mrcc:         0.020,
  onecard:           0.010,
  au_lit:            0.015,
  yes_first:         0.015,
...
export const EARN_RATES: Record<string, Partial<Record<Platform, number>>> = {
  hdfc_infinia:      { amazon: 3.3, flipkart: 3.3, croma: 3.3, vijay_sales: 3.3, reliance_digital: 3.3 },
  hdfc_diners_black: { amazon: 3.3, flipkart: 3.3, croma: 3.3, vijay_sales: 3.3, reliance_digital: 3.3 },
  hdfc_regalia:      { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  hdfc_millennia:    { amazon: 1.5, flipkart: 1.5, croma: 1.5, vijay_sales: 1.5, reliance_digital: 1.5 },
  axis_magnus:       { amazon: 1.2, flipkart: 1.2, croma: 1.2, vijay_sales: 1.2, reliance_digital: 1.2 },
  axis_ace:          { amazon: 2.0, flipkart: 1.5, croma: 1.5, vijay_sales: 1.5, reliance_digital: 1.5 },
  axis_flipkart:     { amazon: 1.5, flipkart: 5.0, croma: 1.5, vijay_sales: 1.5, reliance_digital: 1.5 },
  icici_amazon:      { amazon: 5.0, flipkart: 1.0, croma: 1.0, vijay_sales: 1.0, reliance_digital: 1.0 },
  icici_emeralde:    { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  sbi_cashback:      { amazon: 5.0, flipkart: 5.0, croma: 5.0, vijay_sales: 5.0, reliance_digital: 5.0 },
  sbi_elite:         { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  kotak_811:         { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  idfc_wealth:       { amazon: 1.5, flipkart: 1.5, croma: 1.5, vijay_sales: 1.5, reliance_digital: 1.5 },
  amex_plat_travel:  { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  amex_mrcc:         { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  onecard:           { amazon: 1.0, flipkart: 1.0, croma: 1.0, vijay_sales: 1.0, reliance_digital: 1.0 },
  au_lit:            { amazon: 1.5, flipkart: 1.5, croma: 1.5, vijay_sales: 1.5, reliance_digital: 1.5 },
  yes_first:         { amazon: 1.5, flipkart: 1.5, croma: 1.5, vijay_sales: 1.5, reliance_digital: 1.5 },
  sc_smart:          { amazon: 2.0, flipkart: 2.0, croma: 2.0, vijay_sales: 2.0, reliance_digital: 2.0 },
  sbi_simplysave:    { amazon: 1.0, flipkart: 1.0, croma: 1.0, vijay_sales: 1.0, reliance_digital: 1.0 },
  paytm_wallet:      { amazon: 0,   flipkart: 0,   croma: 0,   vijay_sales: 0,   reliance_digital: 0   },
  amazon_pay:        { amazon: 1.0, flipkart: 0,   croma: 0,   vijay_sales: 0,   reliance_digital: 0   },
  phonepe_wallet:    { amazon: 0,   flipkart: 0,   croma: 0,   vijay_sales: 0,   reliance_digital: 0   },
};
